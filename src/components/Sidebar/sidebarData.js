...
export const DEPTS = {
  ...
  automation: {
    ...
    items: [
      ...
      { key: 'constellation', name: 'AI Agents', desc: 'Карта реальних AI-агентів CRM за відділами — від живих (Follow-up Generator) до запланованих.', icon: IC.constellation, type: 'link', to: '/tools/constellation-test', crackTransition: true },
    ],
  },
  team: {
    label: 'Team',
